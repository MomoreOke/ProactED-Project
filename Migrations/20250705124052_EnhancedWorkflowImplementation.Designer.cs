...
namespace FEENALOoFINALE.Migrations
{
    ...
    [Migration("20250705124052_EnhancedWorkflowImplementation")]
    partial class EnhancedWorkflowImplementation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FEENALOoFINALE.Models.MaintenanceTask", b =>
                {
                    ...
                    b.Property<int?>("OriginatingAlertAlertId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OriginatingAlertAlertId");
            ...
            modelBuilder.Entity("FEENALOoFINALE.Models.MaintenanceTask", b =>
                {
                    ...
                    b.HasOne("FEENALOoFINALE.Models.Alert", "OriginatingAlert")
                        .WithMany()
                        .HasForeignKey("OriginatingAlertAlertId");
